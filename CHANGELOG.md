...
- Added private-data redaction for JSON, text, and support-bundle reports.
- Added the collector, CLI, notifier, hardened units, udev integration, installer, documentation, and CI for a self-contained release.
